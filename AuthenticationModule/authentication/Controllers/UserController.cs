    ...
    public class UserController : Controller
    {
        ...
        public ActionResult MatchOtp(int LoginOtp)
        {
            ...
            {   //string stored = user.GetOtp(userid);
                ...
                if (LoginOtp == stored)
                {
                    return Json(1);//change by Rajesh
                    //return Json(new { message = "login" });//change by Rajesh
                }
                else
                {
                    ViewBag.userid = message;//OTP NOT MATCHED
                    // return Json(00);//change by Rajesh
                    return Json(0);
                }
                //return Json(1);}
    ...
    "CYknodsz77JxHXx8"
           ...
           public ActionResult sendotp(string Mobileno)
        {
          ...
          if (!ismobile)
            ...
            return Json(1);
            //return RedirectToAction("MatchOtp","User");
